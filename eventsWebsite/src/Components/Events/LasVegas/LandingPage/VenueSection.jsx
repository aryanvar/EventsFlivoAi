...
export default function VenueLocation() {
  ...
  const venueAddress = "100 Princes' Blvd, Las Vegas, NV 89101";
  const encodedAddress = encodeURIComponent(venueAddress);
  // Using a more reliable map embed approach
  const mapEmbedUrl = `https://maps.google.com/maps?width=100%25&height=600&hl=en&q=${encodedAddress}&t=&z=15&ie=UTF8&iwloc=&output=embed`;
