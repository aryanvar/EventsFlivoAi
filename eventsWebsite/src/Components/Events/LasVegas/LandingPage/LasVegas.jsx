...
const EnterpriseAISummit = () => {
  ...
  const galleryImages = [
    ...
    { src: CenterImg, alt: 'Las Vegas street level view at sunset' },
    { src: RightImg, alt: 'Las Vegas skyline with reflection on water' },
  ];
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col p-4 sm:p-6 lg:p-8">
        ...
        <main className="flex flex-grow flex-col items-center justify-center relative">
          ...
          <div className="relative w-[900px] ">
            {/* Chicago Title - Large and positioned above images */}
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <img 
                      ...
                      onError={(e) => {
                        // Fallback to high-quality Chicago images if local images fail to load
                        const fallbackUrls = [
                          'https://images.unsplash.com/photo-1494522358652-f30e61a60313?w=1200&h=800&fit=crop&auto=format',
  ...
  <p className="max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl font-medium text-slate-100 mb-8 drop-shadow-lg leading-relaxed">
    Join global tech leaders in Las Vegas this August as we uncover how enterprises can unlock trillion-dollar opportunities with GenAI, LLMs and intelligent automation.
  </p>
