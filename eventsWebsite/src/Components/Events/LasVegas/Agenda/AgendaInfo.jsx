            ...
            >
              ...
              <div className="flex flex-col justify-center w-full h-full gap-6 p-8 md:p-12 md:pl-32">
                <p className="text-xl font-medium md:text-2xl lg:text-[28px] !leading-relaxed">
                  Explore the agenda for the Enterprise AI Summit 2025, Chicago, designed for business leaders, AI experts and transformation strategists. Every session is built around the real-world application of GenAI, LLMs, and intelligent automation.
                </p>
            ...
            >
              <div className="relative flex flex-col items-center justify-center w-full h-full min-h-[350px]">
                ...
                <div className="mt-auto mb-8">
                  <h3 className="text-2xl font-bold lg:text-3xl">McCormick Place</h3>
                  <p className="mt-2 text-base font-medium lg:text-lg">
                    Convention centre <br/> Chicago, Illinois
                  </p>
                </div>
              </div>
            </InfoCard>
