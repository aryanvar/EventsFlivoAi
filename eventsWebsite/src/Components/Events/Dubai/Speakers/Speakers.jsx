...
import Speaker1 from '../../../../assets/Backgrounds/LeftPannelSpeakrs.png';
import Speaker2 from '../../../../assets/Backgrounds/CenterSpeakers.png';
import Speaker3 from '../../../../assets/Backgrounds/RightPannelSpeakers.png';
...
export default function SpeakersPage() {
  const speakerImages = [
    { src: Speaker1, alt: 'Featured Speaker 1' },
    { src: Speaker2, alt: 'Featured Speaker 2' },
    { src: Speaker3, alt: 'Featured Speaker 3' },
  ];

  return (
    <div
      className="relative min-h-screen w-full overflow-hidden bg-transparent font-sans text-slate-50 bg-center bg-cover"
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col p-4 sm:p-6 lg:p-8">
        ...
        <main className="flex flex-grow flex-col items-center justify-center relative">
          ...
          <div className="absolute top-0 left-0 right-0 flex w-full max-w-5xl mx-auto items-center justify-between px-4 mb-8">
            <p className="font-semibold text-slate-300 text-lg md:text-xl">September 21, 2025</p>
            <p className="font-semibold text-slate-300 text-lg md:text-xl">9am - 6pm GMT</p>
          </div>

          {/* Hero Content Container with Overlaid Text */}
        <div className="relative w-full">
  {/* Speakers Title - Large and positioned above images */}
  ...
  <div className="relative w-screen left-1/2 -translate-x-1/2 [perspective:1100px] mb-8 z-30 mt-[-2rem] sm:mt-[-4rem]">
      ...
      {speakerImages.map((image, index) => (
        ...
        >
          <img
            ...
            onError={(e) => {
              // Fallback to high-quality speaker images if local images fail to load
              const fallbackUrls = [
                'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&h=800&fit=crop&auto=format',
                'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=1200&h=800&fit=crop&auto=format',
                'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=1200&h=800&fit=crop&auto=format',
              ];
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-30 px-4 max-w-4xl mx-auto">
      ...
      <p className="max-w-2xl text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-medium text-slate-100 mb-6 sm:mb-8 drop-shadow-lg leading-relaxed">
        Connect with visionary speakers who are shaping the future of enterprise AI and driving trillion-dollar transformations across industries.
      </p>
      ...
      <button
        ...
        onClick={() => console.log('View Speaker Profiles clicked')}
      >
