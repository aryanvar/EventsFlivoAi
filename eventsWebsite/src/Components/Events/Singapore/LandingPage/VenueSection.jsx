...
export default function VenueLocation() {
  ...
  const venueAddress = "Sands Expo & Convention Centre";
  const encodedAddress = encodeURIComponent(venueAddress);
  // Using a more reliable map embed approach
  const mapEmbedUrl = `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.819473178511!2d103.85619657567915!3d1.2820933617884174!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31da1905a913542d%3A0x81a3ad206e972c35!2sSands%20Expo%20%26%20Convention%20Centre!5e0!3m2!1sen!2sin!4v1754921697603!5m2!1sen!2sin%22%20width=%22600%22%20height=%22450%22%20style=%22border:0;%22%20allowfullscreen=%22%22%20loading=%22lazy%22%20referrerpolicy=%22no-referrer-when-downgrade`;

  const handleGetDirections = () => {
    window.open(`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.819473178511!2d103.85619657567915!3d1.2820933617884174!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31da1905a913542d%3A0x81a3ad206e972c35!2sSands%20Expo%20%26%20Convention%20Centre!5e0!3m2!1sen!2sin!4v1754921697603!5m2!1sen!2sin%22%20width=%22600%22%20height=%22450%22%20style=%22border:0;%22%20allowfullscreen=%22%22%20loading=%22lazy%22%20referrerpolicy=%22no-referrer-when-downgrade`, '_blank');
  };
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 bg-black bg-opacity-50 backdrop-blur-lg border-t border-white border-opacity-20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="text-white text-center md:text-left flex-1">
                <h3 className="text-lg md:text-xl font-bold mb-1">Marina Bay Sands Expo</h3>
