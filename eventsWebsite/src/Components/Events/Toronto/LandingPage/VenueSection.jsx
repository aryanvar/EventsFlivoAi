...
export default function VenueLocation() {
  ...
  const venueName = "Enercare Centre Convention Center";
  const venueAddress = "100 Princes' Blvd, Toronto, ON M6K 3C3, Canada";
  const mapEmbedUrl =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2887.629115336735!2d-79.41493742347006!3d43.63507775360219!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b2d6a2f567a91%3A0x7f7258bc1db2aa32!2sEnercare%20Centre!5e0!3m2!1sen!2sin!4v1754905248839!5m2!1sen!2sin";

  const handleGetDirections = () => {
    window.open("https://www.google.com/maps/dir/?api=1&destination=43.63507775360219,-79.41493742347006", "_blank");
  };
  return (
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 bg-black bg-opacity-50 backdrop-blur-lg border-t border-white border-opacity-20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="text-white text-center md:text-left flex-1">
                <h3 className="text-lg md:text-xl font-bold mb-1">Enercare Centre Convention Center</h3>
