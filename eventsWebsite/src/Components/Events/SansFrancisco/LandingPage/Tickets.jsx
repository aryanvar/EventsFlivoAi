...
const Tickets = () => {
  ...
  return (
    <div id="registration-section" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-tr from-gray-100 via-gray-50 to-gray-200 dark:from-gray-950 dark:to-gray-900 relative overflow-hidden min-h-screen">
