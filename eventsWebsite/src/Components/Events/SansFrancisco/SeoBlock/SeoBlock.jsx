          ...
          >
            ...
            <div className="relative z-10"  >
              ...
              <p className="mt-6 text-lg sm:text-xl text-slate-200 font-medium leading-relaxed max-w-3xl">
                ...
                <br /><br />
                Hosted by FlivoAI at the Mascon Center on August 17th, this global campaign kickoff will feature C-suite voices, enterprise AI innovators, and frameworks for capturing real business impact. Whether you lead digital transformation or architect AI solutions, this is where tomorrow's enterprise AI playbook begins.
              </p>
            </div>
          </div>
