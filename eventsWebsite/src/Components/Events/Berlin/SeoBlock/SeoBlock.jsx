          ...
          >
            ...
            <div className="relative z-10"  >
              ...
              <p className="mt-6 text-lg sm:text-xl text-slate-200 font-medium leading-relaxed max-w-3xl">
                ...
                <br /><br />
                Hosted at ECC Berlin (Estrel Congress Center) on September 15th, 2025, this one-day summit explores how intelligent AI agents are redefining decision-making, automation and enterprise value. 
                <br /> <br />
