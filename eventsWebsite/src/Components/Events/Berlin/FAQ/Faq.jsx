...
import Faq1 from '../../../../assets/Backgrounds/FaqLeft.png';
import Faq2 from '../../../../assets/Backgrounds/FaqCenter.png';
import Faq3 from '../../../../assets/Backgrounds/FaqRight.png';
...
const Faq = () => {
  const faqImages = [
    { src: Faq1, alt: 'Event Information' },
    { src: Faq2, alt: 'Questions & Answers' },
    { src: Faq3, alt: 'Support & Help' },
  ];

  return (
    <div
      className="relative min-h-screen w-full overflow-hidden bg-cover font-sans text-slate-50"
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col p-4 sm:p-6 lg:p-8">
        ...
        <main className="flex flex-grow flex-col items-center justify-center relative">
          ...
          <div className="absolute top-0 left-0 right-0 flex w-full max-w-5xl mx-auto items-center justify-between px-4 mb-8">
            <p className="font-semibold text-slate-300 text-lg md:text-xl">September 15, 2025</p>
            <p className="font-semibold text-slate-300 text-lg md:text-xl">9am - 6pm GMT</p>
          </div>

          {/* Hero Content Container with Overlaid Text */}
          <div className="relative w-full">
            {/* FAQ Title - Large and positioned above images */}
            ...
            <div className="relative w-screen left-1/2 -translate-x-1/2 [perspective:1200px] mb-8 z-30 mt-[-2rem] sm:mt-[-4rem]">
                ...
                {faqImages.map((image, index) => (
                  ...
                  >
                    <img
                      ...
                      onError={(e) => {
                        // Fallback to high-quality FAQ images if local images fail to load
                        const fallbackUrls = [
...
Intelligent AI Agents as Strategic Assets <br />
...
Join global AI leaders, architects and innovators to explore how autonomous agents are reshaping enterprise decision-making. Go beyond scripted automation and into systems that learn, adapt and deliver lasting business value.                </p>
                ...
                <button
                  ...
                  onClick={() => console.log('Browse FAQs clicked')}
                >
                  Browse FAQs
                </button>
              </div>
