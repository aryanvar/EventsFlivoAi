...
Where Strategy Meets Intelligence-No Buzzwords Just Breakthroughs
              </BlurredText>
              <p className="mt-6 text-xl text-center md:text-2xl lg:text-[28px] font-semibold">
An exclusive in-person event by FlivoAI              </p>
              <div className="flex flex-col md:flex-row items-center gap-4 mt-4 text-lg md:text-xl font-semibold text-slate-300">
                ...
                <span>Bangalore International Exhibition Centre</span>
              </div>
            </div>
          </InfoCard>
        </div>
...
Explore the full-day agenda for Beyond Automation, a live gathering designed for AI leaders, digital transformation executives and innovation architects. From game-changing keynotes to deep-dive technical sessions, every moment focuses on turning intelligent agents into real enterprise value.                </p>
                <p className="text-xl font-bold md:text-2xl lg:text-[28px]">
Arrive curious. Leave with strategic clarity, peer insights and practical frameworks.                </p>
              </div>
            </InfoCard>
          </div>
            ...
            >
              <div className="relative flex flex-col items-center justify-center w-full h-full min-h-[350px]">
                ...
                <div className="mt-auto mb-8">
                  <h3 className="text-2xl font-bold lg:text-3xl">Bangalore International Exhibition Centre</h3>
                  <p className="mt-2 text-base font-medium lg:text-lg">
                    in <br />Bangalore, Karnataka, India
                  </p>
                </div>
              </div>
            </InfoCard>
