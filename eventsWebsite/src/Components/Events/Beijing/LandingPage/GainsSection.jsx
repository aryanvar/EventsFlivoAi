...
const gainItems = [
  ...
  {
    text: "Learn how AI leaders are designing agent-based systems that drive decision-making, performance and long-term value. ",
  },
  {
    text: "Walk away with architectures, integration models and governance patterns tailored for scalable, secure deployment. ",
  },
  {
    text: "Connect with enterprise architects, GenAI experts and innovation teams building agent ecosystems inside real organizations.",
  },
];
